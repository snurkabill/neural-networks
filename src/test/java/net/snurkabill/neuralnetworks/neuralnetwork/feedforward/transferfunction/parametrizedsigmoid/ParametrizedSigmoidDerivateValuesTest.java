...
import net.snurkabill.neuralnetworks.neuralnetwork.feedforward.transferfunction.ParametrizedSigmoidFunctionForBipolarVector;
...
public class ParametrizedSigmoidDerivateValuesTest {
    ...
    public ParametrizedSigmoidDerivateValuesTest(double input, double expectedResults) {
