...
public class UtilitiesTest {
    ...
    public void stddev() {
        ...
        assertEquals(0.0, Utilities.stddev(new double[] {-1, -1, -1, -1, -1}), tolerance);
        assertEquals(1.0, Utilities.stddev(new double[] {-1, 1}), tolerance);
        assertEquals(2.0, Utilities.stddev(new double [] {4, 4, 4, 2, 5, 5, 7, 9}), tolerance);
        assertEquals(2.98328677, Utilities.stddev(
