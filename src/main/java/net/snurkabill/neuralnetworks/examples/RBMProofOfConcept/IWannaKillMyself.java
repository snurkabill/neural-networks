...
public class IWannaKillMyself {
    ...
    public static void and() {
        ...
        SupervisedBenchmarker benchmarker = new SupervisedBenchmarker(100, 10,
                new MasterNetworkManager("testing RBM", managers));
