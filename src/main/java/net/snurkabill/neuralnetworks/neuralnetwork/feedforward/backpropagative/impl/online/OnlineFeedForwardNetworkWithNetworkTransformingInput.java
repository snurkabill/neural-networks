...
public class OnlineFeedForwardNetworkWithNetworkTransformingInput extends OnlineFeedForwardNetwork {

    private final FeedForwardableNetwork inputTransformation;

    public OnlineFeedForwardNetworkWithNetworkTransformingInput(String name, List<Integer> topology, WeightsFactory wFactory, FFNNHeuristic heuristic,
